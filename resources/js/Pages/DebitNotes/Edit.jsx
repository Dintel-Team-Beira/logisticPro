...
export default function Edit({ debitNote, invoices, clients, reasons }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/debit-notes/${debitNote.id}`);
    };

    return (
        <DashboardLayout>
            <Head title={`Editar ${debitNote.credit_note_number}`} />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-slate-900">Editar Nota de Débito</h1>
                                <p className="mt-1 text-sm text-slate-500">
                                    {debitNote.credit_note_number}
                                </p>
                            </div>
                        </div>
                    </div>
