...
import { FileDown, ArrowLeft, Save, Plus, Trash2 } from 'lucide-react';
import { motion } from 'framer-motion';

export default function Edit({ creditNote, invoices, clients, reasons }) {
    ...
    return (
        <DashboardLayout>
            <Head title={`Editar ${creditNote.credit_note_number}`} />
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-slate-900">Editar Nota de Crédito</h1>
                                    ...
                                    <div className="grid grid-cols-12 gap-4">
                                        ...
                                        <div className="col-span-12 md:col-span-4">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 text-sm border rounded-lg border-slate-300 focus:ring-2 focus:ring-blue-500"
                                                required
                                            />
                                        </div>
